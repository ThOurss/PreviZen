import { User, Role, Pays } from "../models/index.js"
export const getAllUserByRole = async (req, res) => {
    try {
        ...
        const options = {
            attributes: ['id_User', 'username', 'firstname', 'email', 'id_pays'], // On choisit ce qu'on veut afficher
            include: [
                {
                    model: Role,// L'équivalent du JOIN
                    as: 'role',
                    attributes: ['nom'], // On veut juste le nom du rôle
                }, {
                    model: Pays,
                    as: 'pays',
                    attributes: ['nom_fr']
