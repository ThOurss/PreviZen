...
const ConnectionInscription = ({ setIsConnected }) => {
  ...
  const submitInscription = async (e) => {
    ...
    if (data.passwordUserInscription.trim() === "") {
      newErrors.passwordUserInscription =
        "Vous devez renseigner un mot de passe ";
    }

    if (data.confirmerPasswordUser.trim() === "") {
      newErrors.confirmerPasswordUser =
        "Vous devez renseigner la confirmation du mot de passe ";
    }
  ...
  const submitConnection = async (e) => {
    ...
    if (data.passwordUserConnexion.trim() === "") {
      newErrors.passwordUserConnexion =
        "Vous devez renseigner un mot de passe ";
    }
  ...
  return (
    <main className="connexion_inscription">
      ...
      <section className="contenu-connection_inscription">
        <section
          className={`contenu-connection container ${actif ? "actif" : ""}`}
        >
          ...
          <form action="" onSubmit={submitConnection}>
            {errors.generalConnection && (
              <div className="error">{errors.generalConnection}</div>
            )}
            <div className="div-email">
              ...
              {errors.emailConnection && (
                <p className="error">{errors.emailConnection}</p>
              )}
            </div>
            <div className="div-mdp">
              <fieldset>
                ...
                <div>
                  <input
                    type={oeilActif.connection ? "password" : "text"}
                    name="passwordUserConnexion"
                    id="password-user-connexion"
              ...
              {errors.passwordUserConnexion && (
                <p className="error">{errors.passwordUserConnexion}</p>
              )}
            </div>
        ...
        <section
          className={`contenu-inscription container ${!actif ? "actif" : ""}`}
        >
          <form action="" onSubmit={submitInscription} id="formInscription">
            <div className="div-firstname">
              <fieldset>
                ...
                <div>
                  <input
                    type="text"
                    name="firstnameInscription"
                    id="firstname-inscription"
                    required
                  />
                </div>
              </fieldset>
              {errors.firstnameInscription && (
                <p className="error">{errors.firstnameInscription}</p>
              )}
            </div>
              ...
              <fieldset>
                ...
                <div>
                  <input
                    ...
                    id="username-inscription"
                    required
                  />
                </div>
              </fieldset>
              {errors.usernameInscription && (
                <p className="error">{errors.usernameInscription}</p>
              )}
            </div>
              ...
              <div className="pays-no-error">
                ...
                <div className="listePays">
                  ...
                  >
                    ...
                    {pays.map((item) => (
                      <option key={item.id_pays} value={item.id_pays}>
                        {item.nom_fr}
                      </option>
                    ))}
                  </select>
            ...
            <div className="div-email">
              ...
              {errors.emailInscription && (
                <p className="error">{errors.emailInscription}</p>
              )}
            </div>
            <div className="div-mdp">
              <fieldset>
                <aside
                  ...
                  id="passRequirements"
                >
                  <label className="requirement" id="length">
                    Minimum 8 caractères
                  </label>
                  <label className="requirement" id="lowercase">
                    Au moins une minuscule
                  </label>
                  <label className="requirement" id="uppercase">
                    Au moins une majuscule
                  </label>
                  <label className="requirement" id="number">
                    Au moins un nombre
                  </label>
                  <label className="requirement" id="characters">
                    Au moins un caractère spécial :<br></br> (ex: @, #, $,
                    etc.).
                  </label>
                </aside>
                <legend className="legend-mdp">
                  Mot de passe *
                  <button
                    type="button"
                    className="infobulleMdp"
                ...
                <div>
                  <input
                    type={oeilActif.inscription ? "password" : "text"}
                    name="passwordUserInscription"
                    id="password-user-inscription"
              ...
              {errors.passwordUserInscription && (
                <p className="error">{errors.passwordUserInscription}</p>
              )}
            </div>
            <div className="div-confirmer-mdp">
              <fieldset>
                ...
                <div>
                  <input
                    type={`${oeilActif.confirmer ? "password" : "text"}`}
                    name="confirmerPasswordUser"
                    id="confirmer-password-user"
                    autoComplete="off"
                    required
                  />
                  <img
              ...
              {errors.confirmerPasswordUser && (
                <p className="error">{errors.confirmerPasswordUser}</p>
              )}
            </div>
